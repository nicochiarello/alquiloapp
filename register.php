...
<body>
    <div class="min-h-screen flex flex-col flex-1 items-center">

        <!-- Navbar  -->
        <?php include 'includes/navbar.php'; ?>

        <div class="w-full h-full bg-gray-100 flex flex-1 items-center justify-center p-2">
            <div class="bg-white h-full p-8 rounded-2xl shadow-md w-full max-w-md">
                <!-- Logo -->
                ...
                <p class="text-center text-sm text-gray-500 mt-4">
                    ¿Ya tenés una cuenta? <a class="text-blue-600 underline" href="/alquiloapp/login.php">Iniciá
                        sesión</a>
                </p>
